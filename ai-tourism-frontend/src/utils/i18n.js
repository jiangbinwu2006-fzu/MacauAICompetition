...
const messages = {
  'zh-Hans': {
    ...
    itinerary: '行程', generateTrip: '按偏好时间生成路线', generatingTrip: '正在规划', noTrip: '保存偏好后，系统会按照出发和结束时间生成路线', resetTrip: '清空当前路线',
    ...
    transportCompare: '交通方案对比', effort: '体力', cost: '费用', feasible: '可行', infeasible: '冲突', amapTransitPlan: '高德智能公交方案', boardAt: '上车站', alightAt: '下车站', viaStops: '途经站', stationMarkedOnMap: '地图已标记', unknownStationLocation: '站点坐标未返回',
  ...
  'zh-Hant': {
    ...
    itinerary: '行程', generateTrip: '按偏好時間產生路線', generatingTrip: '正在規劃', noTrip: '儲存偏好後，系統會按照出發和結束時間產生路線', resetTrip: '清空目前路線', routeFeasible: '硬約束全部通過', routeConflict: '路線存在衝突',
    ...
    transportCompare: '交通方案比較', effort: '體力', cost: '費用', feasible: '可行', infeasible: '衝突', amapTransitPlan: '高德智能公交方案', boardAt: '上車站', alightAt: '下車站', viaStops: '途經站', stationMarkedOnMap: '地圖已標記', unknownStationLocation: '未傳回站點座標', recommendations: '沿途自然推薦', addToTrip: '加入路線', remindLater: '稍後提醒', ignore: '忽略', detour: '繞行 +{minutes} 分鐘 / {meters} 米',
  ...
  en: {
    ...
    itinerary: 'Trip', generateTrip: 'Generate route for my time window', generatingTrip: 'Planning', noTrip: 'Save preferences to generate a route for your selected start and end time', resetTrip: 'Clear current route', routeFeasible: 'All hard constraints pass', routeConflict: 'Route conflicts found',
    ...
    transportCompare: 'Transport comparison', effort: 'Effort', cost: 'Cost', feasible: 'Feasible', infeasible: 'Conflict', amapTransitPlan: 'AMap smart transit plan', boardAt: 'Board at', alightAt: 'Alight at', viaStops: 'Via stops', stationMarkedOnMap: 'Marked on map', unknownStationLocation: 'Station coordinates unavailable', recommendations: 'On-route public recommendations', addToTrip: 'Add to route', remindLater: 'Remind later', ignore: 'Ignore', detour: 'Detour +{minutes} min / {meters} m',
  ...
  pt: {
    ...
    itinerary: 'Itinerario', generateTrip: 'Criar rota para o horario escolhido', generatingTrip: 'A planear', noTrip: 'Guarde as preferencias para criar uma rota entre a hora de inicio e de fim escolhidas', resetTrip: 'Limpar rota atual', routeFeasible: 'Todas as restricoes cumpridas', routeConflict: 'Conflitos na rota',
